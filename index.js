...
//   POST /api/schedules           新建定时任务 {caseId, group?, cron, notifyOn?}（caseId 与 group 二选一；notifyOn: all|failure，M20）
//   PUT  /api/schedules/:id       更新定时任务（cron/enabled/group/caseId/notifyOn）
